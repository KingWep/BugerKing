    ...
    <>
      <div className='w-full pt-[60px] pb-10'>
        ...
        <div className='md:w-[70%] w-[80%] m-auto grid md:grid-cols-2 grid-cols-1 md:gap-8 gap-3 mt-14 lg:mt-20 ' >
          <img src="/img/home/p1.png" alt="" data-aos="zoom-in-right"/>
          <img src="/img/home/p2.png" alt="" data-aos="zoom-in-left"/>
        </div>
        <div className='md:w-[70%] w-[80%] m-auto grid md:grid-cols-2 grid-cols-1 md:gap-8 gap-3 mt-6 text-red-100'>
          <div className='text-center flex flex-col justify-center items-center py-16 rounded-lg bg-red-800 cursor-pointer' data-aos="zoom-in-right">
          ...
          <div className='text-center flex flex-col justify-center items-center py-16 rounded-lg bg-orange-600 cursor-pointer' data-aos="zoom-in-left">
