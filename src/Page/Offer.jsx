    ...
    <> 
      <div className="m-auto w-[90%] pt-[60px] pb-16">
        ...
        <div className="w-full flex justify-center gap-2 mt-5">
          <button className="bg-red-600 px-2 lg:px-3 py-1 md:py-2 flex justify-center items-center gap-2 rounded-[16px] text-red-100 lg:text-[15px] text-[12px] font-semibold">
        ...
        <h1 className="text-red-600 lg:mt-8 lg:mb-8 mt-5 mb-5 font-bold lg:text-[40px] md:text-[30px] text-[25px] flex items-center justify-center w-full">All Menu</h1>
        <OfferMenu/>
      </div>
    </>
  )
