...
export default function Register({ onSwitchToLogin }) {
    return (
        <>
            <form action="" className='lg:w-[450px] md:w-[400px] w-[90%] m-auto h-auto pb-5 rounded-[20px] px-5 gap-5 overflow-hidden bg-orange-500/80'>
                ...
                <div className='w-full gap-5 flex justify-between'>
                    <div className='w-full flex flex-col'>
                        ...
                        className='rounded-[16px] py-2 px-2 w-full bg-white/20 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-orange-400' />
                    </div>
                    <div className='w-full flex flex-col'>
                ...
                <div className='w-full flex flex-col'>
                    ...
                    <input type="password" placeholder='Confirm Password' className='rounded-[16px] py-2 px-2 w-full bg-white/20 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-orange-400' />
                </div>
                ...
                {/* Button */}
                <button className="w-full mt-6 py-3 rounded-[16px] bg-orange-400 hover:bg-orange-500 transition font-semibold text-white text-sm sm:text-base shadow-lg">
                    REGISTER
                </button>
