...
export default function BugerCard({ name, price, img }) {
    ...
    return (
        <div className=" bg-orange-100 rounded-tr-[50px] rounded-bl-[50px] rounded-br-[5px] rounded-tl-[5px] shadow-lg overflow-hidden relative group" data-aos="zoom-in-up">
