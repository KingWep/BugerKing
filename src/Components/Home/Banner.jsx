  ...
  return (
    <div className="relative w-full md:h-[400px] h-[350px]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20 text-white text-center">
        ...
        <h1 className="lg:text-[70px] text-[45px] font-serif font-extrabold animate-pulse">Through Delivery</h1>
        <div className="md:mt-10 mt-8 flex gap-3">
          <button className="px-3 py-2 md:font-semibold font-medium bg-red-700 text-white rounded-full hover:bg-green-400 duration-300">
            Order Pickups
          </button>
          <button className="px-3 py-2 md:font-semibold font-medium bg-orange-400 text-white rounded-full  hover:bg-green-400 duration-300">
            Order Delivery
          </button>
        </div>
      </div>
